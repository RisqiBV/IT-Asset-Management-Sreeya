...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="card">
             ...
             <a href="download_peg.php" class="btn btn-success " style="float:left;margin:5px;">
                  ...
                  <tr style="background-color:#28a745;">
                    ...
                    <?php    
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    <td ><?= $nomor ?></td>
									                  <td><a href="detail_peg.php?serial_number=<?=$data['serial_number'] ?>" target="_blank"><?= $data['serial_number'] ?> </a></td>
                                    <td><?= $data['hostname'] ?> </td>                         
                                    <td><?= $data['OS_name'] ?> </td>
                                </tr>
