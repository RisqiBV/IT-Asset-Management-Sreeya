    ...
    <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
            ...
            <form action="" method="POST">
                ...
                <input class="form-control form-control-sm" type="text" name="username" value="<?=$data['username']?>"  placeholder="Username">
                <br>
                <input class="form-control " type="text" name="nama_admin" value="<?=$data['nama_admin']?>" placeholder="Nama">
                <br>
                <input class="form-control form-control-sm" type="text" name="jabatan" value="<?=$data['jabatan']?>">
                <br>
                <input class="form-control form-control-sm" type="text" name="level"  value="<?=$data['level']?>">
                <br>
                <input class="form-control form-control-sm" type="text" name="password"  value="<?=$data['password']?>">
                <br>
