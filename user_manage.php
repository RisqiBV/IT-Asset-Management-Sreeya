  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="card">
              <div class="card-header">
                <center><h3>TABEL USER</h3></center>
              </div>
              <div class="card-body" >   
              <a href="adduser.php" class="btn btn-success " style="float:left;">
                <i class="fas fa fa-plus-circle"></i> Add User
             </a>    
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <!-- <a href="?page=admin&actions=pesertadetail&id=<?= $data['bib'] ?>  " class="btn btn-info btn-xs">
                                        ...
                                        <a href="deleteuser.php?username=<?= $data['username'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda Ingin Menghapus User?')">
                                            <span class="fas fa-times-circle"> Hapus </span>
                                        </a>
                                    </td>
                                </tr>
