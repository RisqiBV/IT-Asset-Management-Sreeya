...
if($_SESSION['level']==""){
  header("location:asset.php?pesan=Kamu blm login bestie");
}
    ...
    <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
            ...
            <form action="proses_addasset.php" method="POST">
                ...
                <br>
                <input class="form-control form-control-sm" type="text" name="serial_number" placeholder="Serial Number" required>
                <br>
                ...
                <br>
                <button type="submit" name="simpan" class="btn btn-success"> <i class="fas fa fa-save"></i> Simpan</button>
            </form>
