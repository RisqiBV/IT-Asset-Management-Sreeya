        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <?php
                include 'koneksi.php';
                $data_admin = mysqli_query($db,"SELECT * FROM  tb_admin");
              ...
              <a href="user_manage.php" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="asset.php" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
...
['rgb(255, 99, 132)', 'rgba(56, 86, 255, 0.87)', 'rgb(60, 179, 113)','rgb(175, 238, 239)'],
  ...
  <footer class="main-footer">
    <center><strong>Copyright &copy; 2022 <a href="https://sreeyasewu.com/en/home"target="_blank">Sreeya Sewu Indonesia</a></a>.</strong></center>
    </div>
  </footer>
