...
<section class="content">
    ...
    <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
            ...
            <form action="" method="POST">
                ...
                <br>
                <input class="form-control form-control-sm" type="text" name="department" value="<?=$data['department']?>"  placeholder="Department">
                <br>
                <input class="form-control form-control-sm" type="text" name="lokasi" value="<?=$data['lokasi']?>"  placeholder="Lokasi">
                <br>
                <input class="form-control form-control-sm" type="text" name="email" value="<?=$data['email']?>"  placeholder="Email">
              
                <br>
                <button type="submit" name="submit_edit" class="btn btn-success"> <i class="nav-icon fas fa-edit"></i> Update</button>
            </form>    
  ...
  <footer class="main-footer">
    <center><strong>Copyright &copy; 2022 <a href="https://sreeyasewu.com/en/home"target="_blank">Sreeya Sewu Indonesia</a>.</strong></center>
    </div>
  </footer>
